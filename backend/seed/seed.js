...
const PROJECTS = [
  {
    ...
    description:
      'A premium full-stack MERN food ordering application integrated with Stripe payment checkout, admin dashboard order processing, dynamic cart management, and on-demand LLM sentiment analysis for restaurant reviews.',
    problem:
      'Standard food delivery templates lack interactive AI capabilities, secure and automated order status update panels for administrators, and robust, crash-free review aggregation tools.',
    features: [
